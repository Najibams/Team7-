...
">
<b>📘 Legenda</b><br><br>
<div style="margin-bottom: 6px;"><span style="display:inline-block;width:12px;height:12px;background-color:#00ff00;border-radius:50%;margin-right:6px;border:1px solid white;"></span> Short Haul</div>
<div style="margin-bottom: 6px;"><span style="display:inline-block;width:12px;height:12px;background-color:#ffa500;border-radius:50%;margin-right:6px;border:1px solid white;"></span> Middle Haul</div>
<div style="margin-bottom: 6px;"><span style="display:inline-block;width:12px;height:12px;background-color:#ff0000;border-radius:50%;margin-right:6px;border:1px solid white;"></span> Long Haul</div>
<div style="margin-bottom: 6px;"><span style="display:inline-block;width:12px;height:12px;background-color:#ffff00;border-radius:50%;margin-right:6px;border:1px solid white;"></span> SEL_dB ≤ 55</div>
<div style="margin-bottom: 6px;"><span style="display:inline-block;width:12px;height:12px;background-color:#ffa500;border-radius:50%;margin-right:6px;border:1px solid white;"></span> SEL_dB 55–70</div>
<div style="margin-bottom: 6px;"><span style="display:inline-block;width:12px;height:12px;background-color:#ff0000;border-radius:50%;margin-right:6px;border:1px solid white;"></span> SEL_dB ≥ 70</div>
<div style="margin-bottom: 0;"><span style="display:inline-block;width:12px;height:12px;background-color:#00ff00;border-radius:50%;margin-right:6px;opacity:0.3;border:1px solid white;"></span> Schiphol Meetgebied</div>
</div>
